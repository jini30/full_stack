...
sequenceDiagram
  ...
  New note is created and added to the notes array and target value of input element is reset
  The div element with id 'notes' is redrawn after new note has been added to the notes array
